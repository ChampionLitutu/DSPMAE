...
def main(args):
    ...
    for i, seed in enumerate(seeds):
        ...
        logyyx.info(f"# final_f1: {final_acc:.4f}")
        logyyx.info(f"# early-stopping_f1: {estp_acc:.4f}")
    ...
    logyyx.info(f"# final_f1: {final_acc:.4f}±{final_acc_std:.4f}")
    logyyx.info(f"# early-stopping_f1: {estp_acc:.4f}±{es_acc_std:.4f}")
